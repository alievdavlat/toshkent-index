...
const Feedback = () => {
    ...
    const feedbackModalVisible = useSelector(state => state.system.feedbackModalVisible);
            ...
            <div className="feedback" role='button'>
                <div className='account-popup account-popup__delete' style={{ display: modal ? 'block' : 'none', zindex: 1000 }}>
                    <div className='account-popup__content'>
                        ...
                        <button className='btn' onClick={()=> setModal(false)}>{t('finish')}</button>
                    </div>
                </div>
                <Modal open={feedbackModalVisible} footer={false} onCancel={() => dispatch(feedbackModalVisibleHandler(false))} closeIcon={() => null} className='ant-modal'>
                    <div className="feedback-content">
                        ...
                        <Main
                            ...
                            onSuccess={(data, resetForm) => {
                                dispatch(feedbackModalVisibleHandler(false));
                                setModal(true);
                                countDown();
                                resetForm();
                            }}

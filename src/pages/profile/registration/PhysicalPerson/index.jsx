                ...
                {({ errors, touched }) => {
                    return (
                        <Form className='login-form' id={formid}>
                            ...
                            <div className="form-item" style={{marginBottom: '1.8rem'}}>
                                <div className="form-item__name">
                                    {t('repeatPassword')}
                                </div>
                                <div className="form-item__input eye-control">
                            ...
                            <button type='submit' className={`login-form__btn btn ${!isChecked ? 'btn-disabled' : ''}`} suppressHydrationWarning={true}>
                                {t('enterPassword')}
                            </button>
                        </Form>
                    )
